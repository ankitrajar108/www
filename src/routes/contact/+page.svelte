<script>
	...
	const handleSubmit = async (data) => {
		...
		object.access_key = 'f94b5dbc-b83e-4ddf-82da-b4b5433b13b0';
	...
	const copyEmail = async () => {
		await navigator.clipboard.writeText('ankitydv@zohomail.in');
		emailCopied = true;
...
<main>
	...
	<div class="info">
		...
		<a href="mailto:ankitydv@zohomail.in" class="external"
			>ankitydv@zohomail.in<span class="arrow">/></span>
		</a>
